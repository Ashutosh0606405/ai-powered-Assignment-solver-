    ...
    <div className="auth-container">
      ...
      <style>{`
        ...
        .bg-brand-watermark {
          ...
          user-select: none;
          white-space: nowrap;
          animation: breathingWatermark 12s infinite ease-in-out;
        }

        @keyframes breathingWatermark {
          0%, 100% {
            transform: translate(-50%, -50%) rotate(-8deg) scale(1);
            text-shadow: 0 0 10px rgba(255, 255, 255, 0.25), 0 0 20px rgba(59, 130, 246, 0.15);
            opacity: 0.14;
          }
          50% {
            transform: translate(-50%, -46%) rotate(-7deg) scale(1.03);
            text-shadow: 0 0 15px rgba(255, 255, 255, 0.45), 0 0 30px rgba(59, 130, 246, 0.35);
            opacity: 0.22;
          }
        }
